    ...
    <div class="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-3 text-sm sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs sm:text-sm">
        <a
          ...
          备案号: 浙ICP备18053383号-3
        </a>

        <a href="mailto:tcyeee@outlook.com" class="transition-colors text-gray-300 hover:text-white">
          联系：tcyeee@outlook.com
        </a>
      </div>

      <a href="https://wj.qq.com/s2/25315374/f339" target="_blank" rel="noreferrer" class="text-gray-500 sm:inline-block">
        问题反馈
      </a>
    </div>
  </footer>
