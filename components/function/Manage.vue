<template>
  <div>
    <div @click.stop="select()" onclick="dialog_manage.showModal()">
    ...
    <dialog id="dialog_manage" class="cy-modal">
      <div class="cy-modal-box w-11/12 max-w-5xl">
        <h3 class="font-bold text-lg">书签管理</h3>
