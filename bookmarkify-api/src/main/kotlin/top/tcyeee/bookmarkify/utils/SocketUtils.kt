...
object SocketUtils {
    ...
    /**
     * 向发起「系统书签集」批量抓取的管理员推送某条链接的抓取进度（ADMIN realm）
     */
    fun systemCollectionCrawlUpdate(adminUid: String, update: CollectionCrawlUpdate) =
        SessionManager.send(SocketMsgType.SYSTEM_COLLECTION_CRAWL_UPDATE, RoleEnum.ADMIN.name, adminUid, update)
