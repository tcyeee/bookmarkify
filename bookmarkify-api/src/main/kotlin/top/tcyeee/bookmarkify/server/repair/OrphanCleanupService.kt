...
class OrphanCleanupService(
    ...
    private val siteSimilarItemMapper: SiteSimilarItemMapper,
) {
    ...
    companion object {
        ...
        val OWNERSHIP_REGISTRY: Map<KClass<*>, Disposition> = mapOf(
            ...
            // 「更多相似书签」的 AI 缓存，属主是 site_id；站点被清掉时随之删除
            SiteSimilarItemEntity::class to Disposition.Cascade,
    ...
    fun run(dryRun: Boolean): OrphanCleanupReport {
        ...
        report.similarItems = purge(siteSimilarItemMapper, doomedSiteIds, dryRun) { `in`(SiteSimilarItemEntity::siteId, it) }
