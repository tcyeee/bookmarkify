...
| `site_asset` / `page_meta` / `scrape_snapshot` | Crawl results, one writer (`SiteAssetWriter`), crawl facts only (replaced `bookmark_logo`; see root `AGENTS.md`). A fourth, `site_display_pref`, held admin icon tweaks and was dropped on 2026-08-17 — icon quality is a rules problem, see `ICON-DISPLAY-TODO.md` |
